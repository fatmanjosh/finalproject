...
=======
>>>>>>> 927616290c8af4123435a0168a901b49c1fc4c58
        for state in states:
...
#
# import random
# # uncomment this to run on terminal
# # import rospy
...
#
#         self.states = \
#             {'s0': (0, 0), 's1': (1, 0), 's2': (2, 0), 's3': (3, 0), 's4': (4, 0), 's5': (5, 0), 's6': (6, 0),
#              's7': (7, 0),
...
#                     if not direction in self.possible_transitions[
#                         state]:  # if you cant move in that direction from state
